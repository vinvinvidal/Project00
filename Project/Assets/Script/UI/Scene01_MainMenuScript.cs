...
public class Scene01_MainMenuScript : GlobalClass
{
	...
	void Start()
    {
		...
		//衣装装備のオブジェクトルート取得
		CostumeOBJ = GameObject.Find("CostumeEquip");
		...
		CostumeSelectScrollBarOBJ = DeepFind(CostumeOBJ, "CostumeList");
	...
	//衣装リストで決定された時の処理
	public void CostumeListSubmit()
	{

	}

	//衣装リストで選択変更された時の処理
	public void CostumeListMove()
	{
