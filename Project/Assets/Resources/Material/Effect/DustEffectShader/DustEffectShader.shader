Shader "Custom/DustEffectShader"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			{
				//fixed4 re = (dot(i.normal, _WorldSpaceLightPos0) + 1);				

				fixed4 re = tex2D(_MainTexture, i.uv * _MainTexture_ST.xy + _MainTexture_ST.zw)* 0.5 * _LightColor0;
